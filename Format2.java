...
public class Format2{
  public static void main(String[] args){
    ...
    String names[]={"Joe Okoth","James Ruth","Joel Maina","Ladiah Joe","Joice Steph","JudyNjoroge","James Kiptoo","Steph Woren","Maria James","Philis Wakah"};
    ...
    System.out.println(String.format("%12s %9s %9d %9d %9d", strname,num,cat1,cat2,exam));
    }
